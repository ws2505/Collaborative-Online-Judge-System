...
var EditorComponent = (function () {
    ...
    EditorComponent.prototype.initEditor = function () {
        ...
        this.editor.on('change', function (e) {
            ...
            if (e != _this.editor.lastAppliedChange) {
...
var ProblemDetailComponent = (function () {
    function ProblemDetailComponent(route, 
...
var AuthService = (function () {
    function AuthService(router) {
        ...
        this.auth0 = new __WEBPACK_IMPORTED_MODULE_3_auth0_js__["WebAuth"]({
            clientID: 'G2Hb15YEgA2_ZIjDo2sO6d8o0oVxZbaB',
            domain: 'aleena.auth0.com',
            responseType: 'token id_token',
            audience: 'https://aleena.auth0.com/userinfo',
...
var DataService = (function () {
    ...
    DataService.prototype.addProblem = function (problem) {
        ...
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]({ "contetn-type": "application/json" });
